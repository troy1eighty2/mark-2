...
ll
vim config.ini
vi /etc/polybar/config.ini 
vim /etc/polybar/config.ini 
vim config.ini
polybar
vim config.ini
polybar example
...
git clone git@github.com:troy1eighty2/mark-2.git
...
ssh-keygen -t ed25519 -C "troytran000@gmail.com"
ll
cd .config/
ll
ll
